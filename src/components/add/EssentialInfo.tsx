...
// import { Google as GoogleIcon } from '../icons/google'; 
  ...
  const Index = ({setDisabled}:{setDisabled:any}) => {
    ...
    const req= await fetch(`api/getbyid?pid=${id}`)
...
const req = await fetch(`api/${id && mode === 'edit' ? `update?pid=${id}`: `save`}`,{
  method: 'POST',
  headers: {
...
//   });
  ...
  >
    ...
    {['Coffee machine', 'espresso pod', 'Espresso capsules', 'Machine spareparts', 'Today offer', 'Nescafe and more', 'Nuts and jelly'].map((item:string) =>{
